...
export async function uploadTrack(
  file,
  { title, artist_id, album_id, duration_seconds = 0, image_path, lyrics_text }
) {
  return uploadTrackWithProgress(file, { title, artist_id, album_id, duration_seconds, image_path, lyrics_text });
}
...
export function uploadTrackWithProgress(
  ...
  if (lyrics_text != null && lyrics_text !== "") form.append("lyrics_text", lyrics_text);
...
export async function updateTrack(
  id,
  { title, artist_id, album_id, image_path, featured_artist_ids, lyrics_text }
) {
  const body = {};
  ...
  if (lyrics_text !== undefined) body.lyrics_text = lyrics_text;
